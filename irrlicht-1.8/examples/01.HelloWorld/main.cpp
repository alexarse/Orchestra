...
int main()
{
	...
	*/
	...
	params.WindowSize = core::dimension2d<u32>(600, 500);
	params.Bits = 32;
	...
	*/
	//gangnam_style_2.dae
	//IAnimatedMesh* mesh = smgr->getMesh("../../media/test_B3D.b3d");
	//IAnimatedMesh* mesh = smgr->getMesh("../../media/gangnam_style_2.b3d");
	IAnimatedMesh* mesh = smgr->getMesh("../../media/test_B3D.b3d");
	if (!mesh)
	{
		device->drop();
	...
	*/
	if (node)
	{
		...
		node->setMaterialTexture( 0, driver->getTexture("../../media/test_m.png") );
		//node->setMaterialTexture( 0, driver->getTexture("../../media/MocapGuy_DIFF.tga") );
	...
	*/
	...
	smgr->addCameraSceneNode(0, vector3df(0, 1.45, 1.5), vector3df(0, 1, 0));
	//smgr->addCameraSceneNode(0, vector3df(0,0.5,1.8), vector3df(0,0.8,0));
	...
	*/
	while(device->run())
	{
		...
		*/
		driver->beginScene(true, true, SColor(80,80,80,80));
